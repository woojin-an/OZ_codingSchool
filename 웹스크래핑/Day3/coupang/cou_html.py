...
with open(f"/Users/woojinan/Desktop/school/OZ_codingSchool/웹스크래핑/Day3/coupang/{file_name}", "w", encoding="utf-8") as f:
    f.write(f"{html_text}")

# ftp_domain = "ysh.dothome.co.kr"
# ftp_id =" "
# ftp_pw =" "
#
# ftp = ftplib.FTP()
